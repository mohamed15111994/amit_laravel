            ...
            <ul class="sidebar-menu">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('adminpanel/add') }}">
                                <i class="fa fa-plus"></i><p> Add member</p>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('adminpanel/update') }}">
                                <i class="fa fa-archive"></i><p> update</p>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('adminpanel/form') }}">
                                <i class="fa fa-paperclip"></i><p> form</p>
                            </a>
                        </li>
                    </ul>
                </li>
